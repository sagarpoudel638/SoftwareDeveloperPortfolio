...
const Footer = () => {
  ...
  return (
    <footer 
      ref={section.ref}
      className={`py-12 bg-white dark:bg-slate-900 frosted-glass ${section.className}`}
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-md">
              A passionate software developer specializing in MERN stack, Python, cloud computing, and full-stack development.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            &copy; {currentYear} Sagar Poudel. All rights reserved.
          </p>
